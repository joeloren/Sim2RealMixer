...
class NoisyLander(LunarLander):
    ...
    def __init__(self, max_skew: float, seed=None):
        ...
        rand_state = np.random.RandomState(seed=seed) if seed else None
        print("Original MAIN_POWER_ENGINE: ", self.MAIN_ENGINE_POWER)
        self.MAIN_ENGINE_POWER = skew_by(self.MAIN_ENGINE_POWER, rand_state, max_skew)
        print("Modified MAIN_POWER_ENGINE: ", self.MAIN_ENGINE_POWER)
        self.SIDE_ENGINE_POWER = skew_by(self.SIDE_ENGINE_POWER, rand_state, max_skew)
    ...
    def step(self, action):
        ...
        if (self.continuous and np.abs(action[1]) > 0.5) or (not self.continuous and action in [1, 3]):
            ...
            p.ApplyLinearImpulse((ox * self.SIDE_ENGINE_POWER * s_power, oy * self.SIDE_ENGINE_POWER * s_power), impulse_pos,
                                 True)
